...
CONFIG_SCHEMA = {
    "plugin": {
        "name": ConfigField(type="string", default="maimai_selfie_plugin", description="插件名称"),
        "version": ConfigField(type="string", default="1.0.0", description="插件版本"),
        "enabled": ConfigField(type="boolean", default=True, description="是否启用插件"),
        "config_version": ConfigField(type="string", default="1.0.0", description="配置文件版本"),
    },
    "selfie": {
        "enabled": ConfigField(type="boolean", default=True, description="是否启用自拍功能"),
